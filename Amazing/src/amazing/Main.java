	...
	public static void main(String[] args) {
	   ...
	   EmpresaAmazing empresa = new EmpresaAmazing("30-456789-2"); 
		  ...
		  int paq2= empresa.agregarPaquete(p4, 1290, 5500, 1100);
		   int paq3= empresa.agregarPaquete(p1, 5400, 13400, 3, 400); //especial  3 son de p1 y 1 de p4
		   ...
		   int paq9= empresa.agregarPaquete(p4, 120000, 56000, 2, 1100); // especial //DESCARTADO
		   ...
		   System.out.println();
		   System.out.println(empresa.cargarTransporte("AA222FF")); // volumen max 18k 
