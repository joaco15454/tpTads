...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    //  empresa.registrarAutomovil("AB454ZZ", 10000, 3500, 5);
  ...
  /*  int p4 = empresa.registrarPedido("Beatriz Espinoza", "L.Alberdi 549", 20345678);
   ...
   int paq1 = empresa.agregarPaquete(p1, 1235, 2890, 1000);
    int paq3 = empresa.agregarPaquete(p1, 5400, 13400, 3, 40); // 17772
    //int paq8 = empresa.agregarPaquete(p1, 35000, 134000, 3, 400);
    
   // int paq2 = empresa.agregarPaquete(p1, 1290, 5500, 1100);
   ...
   // int paq9 = empresa.agregarPaquete(p4, 120000, 56000, 2, 1100);
    ...
    //empresa.cargarTransporte("AA222FF");
    
    System.out.println("CERRAR PEDIDO: \n" + empresa.cerrarPedido(p1));
    System.out.println("CERRAR PEDIDO: 3 \n"+ empresa.cerrarPedido(p3));
    
    System.out.println("FACTURACION TOTAL: + \n" + empresa.facturacionTotalPedidosCerrados());
   
  // 	
    										/*DOS ESPECIALES, NO CAMBIA PRECIO, 
    										DOS ORDINARIOS GENERA PROBLEMAS CON valorActual += paquete.costoFinal(); */
   // empresa.cerrarPedido(p3);
 ...
 //   System.out.println(    empresa.facturacionTotalPedidosCerrados());
  ...
  /*  empresa.cerrarPedido(p6);
   ...
   /* System.out.println(empresa.cargarTransporte("AE555YY"));
    ...
    System.out.println();*/
 //   System.out.println(empresa.getFacturacionTotalPedidosCerrados());
